...
const selectPerson = async (persona) => {
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      {/* Buscador */}
      <div style={{ maxWidth: 520, display: 'grid', gap: 10, marginBottom: 16 }}>
...
const btnPrimary = { padding: '8px 14px', background:'#0b5ed7', color:'#fff', border:'none', borderRadius:6, cursor:'pointer' };
