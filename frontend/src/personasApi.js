  ...
  export const personasApi = {
    ...
    // ✅ CORREGIDO: editarMedia usando fetch + FormData (sin http)
    // Editar metadata de un media (sin cambiar archivo)
// ✅ CORRECTO: editarMedia usando FormData
editarMedia: async (idPersona, idMedia, data) => {
  ...
  const res = await fetch(`${API}/api/personas/${idPersona}/media/${idMedia}`, {
    method: 'PUT',
    body: fd,  // ← Sin Content-Type, el navegador lo configura automáticamente
  });
